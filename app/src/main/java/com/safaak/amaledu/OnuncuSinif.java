...
public class OnuncuSinif extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onuncu_sinif);

        mAdView = findViewById(R.id.adView10);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        listViewon = findViewById(R.id.listviewon);
        ...
        listViewon.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {

                AlertDialog.Builder alert = new AlertDialog.Builder(OnuncuSinif.this);
                ...
                if (useremailFromFB.get(position).equals(currentemail) || currentemail.equals(adminEmail)){
                    alert.setNeutralButton("Kaldır", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            DocumentReference db = firebaseFirestore1.collection("tenthgradeposts").document(postCommentIDD);
                            db.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    db2.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Toast.makeText(OnuncuSinif.this, "Succesfully deleted", Toast.LENGTH_SHORT).show();
                                        }
                                    }).addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(OnuncuSinif.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        FirebaseFirestore.getInstance().collection("reportPost").document(postCommentIDD).set(reportmap)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(OnuncuSinif.this, "Succesfully reported", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
    ...
    public void getDataFromFirebaseFirestore(){
        ...
        CollectionReference collectionReference = firebaseFirestore.collection("tenthgradeposts");
