...
public class OnBirinciSinif extends AppCompatActivity {

    ListView listViewOnBir;
    PostClass adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_birinci_sinif);

        mAdView = findViewById(R.id.adView11);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        listViewOnBir = findViewById(R.id.listViewOnbir);
        ...
        listViewOnBir.setAdapter(adapter);
        ...
        listViewOnBir.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        listViewOnBir.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {

                AlertDialog.Builder alert = new AlertDialog.Builder(OnBirinciSinif.this);
                ...
                if (useremailFromFB.get(position).equals(currentemail) || currentemail.equals(adminEmail)){
                    ...
                    alert.setNeutralButton("Kaldır", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            DocumentReference db = firebaseFirestore1.collection("eleventhgradeposts").document(postCommentIDD);
                            db.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    db2.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Toast.makeText(OnBirinciSinif.this, "Succesfully deleted", Toast.LENGTH_SHORT).show();
                                        }
                                    }).addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(OnBirinciSinif.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        FirebaseFirestore.getInstance().collection("reportPost").document(postCommentIDD).set(reportmap)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(OnBirinciSinif.this, "Succesfully reported", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
    ...
    public void getDataFromFirebaseFirestore(){
        ...
        CollectionReference collectionReference = firebaseFirestore.collection("eleventhgradeposts");
