...
public class DokuzuncuSinif extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dokuzuncu_sinif);
       ...
       // firebaseDatabase = FirebaseDatabase.getInstance();
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(DokuzuncuSinif.this);
                ...
                if (useremailFromFB.get(position).equals(currentemail) || currentemail.equals(adminEmail)){
                    ...
                    alert.setNeutralButton("Kaldır", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            DocumentReference db = firebaseFirestore1.collection("ninthgradeposts").document(postCommentIDD);
                            db.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    db2.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Toast.makeText(DokuzuncuSinif.this, "Succesfully deleted", Toast.LENGTH_SHORT).show();
                                        }
                                    }).addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(DokuzuncuSinif.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            FirebaseFirestore.getInstance().collection("reportPost").document(postCommentIDD).set(reportmap)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Toast.makeText(DokuzuncuSinif.this, "Succesfully reported", Toast.LENGTH_SHORT).show();
                                        }
                                    }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
